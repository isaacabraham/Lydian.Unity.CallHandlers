...
namespace ConsoleApplication1
{
	...
	public class SampleSubscriber
	{
		public void Subscribe(IUnityContainer container)
		{
			...
			logPublisher.OnMethodStarted += (_, e) => Console.WriteLine("Entered method {0}.", e.Method.Name);
			logPublisher.OnMethodCompleted += (_, e) => Console.WriteLine("Exited method {0}.", e.Method.Name);
