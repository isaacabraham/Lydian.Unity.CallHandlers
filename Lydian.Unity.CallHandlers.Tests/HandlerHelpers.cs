...
namespace Lydian.Unity.CallHandlers.Tests
{
    ...
    {
        public static void RegisterTypeWithCallHandler<THandler, TTestClass>(this IUnityContainer container, bool withAllMembersPolicy = true) where THandler : ICallHandler
        {
            if (withAllMembersPolicy)
            {
